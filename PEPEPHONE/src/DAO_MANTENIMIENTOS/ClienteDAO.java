     ...
     public Cliente BuscarCliente(int idClie){
         ...
         try {
            ...
            if(resultado.next()){
                ...
                clie.setIdCategoria(resultado.getInt(2));
                clie.setNombCliente(resultado.getString(3));
                clie.setApellCliente(resultado.getString(4));
                clie.setDocCliente(resultado.getInt(5));
                clie.setTelefono(resultado.getInt(6));
                clie.setCorreo(resultado.getString(7));
            }
        }catch(java.sql.SQLException e){
            e.printStackTrace();
        }
